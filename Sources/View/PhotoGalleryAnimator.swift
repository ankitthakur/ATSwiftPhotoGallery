//
//  PhotoGalleryAnimator.swift
//  ATSwiftPhotoGallery
//
//  Created by Likemind on 08/09/21.
//

import UIKit

import QuartzCore
// Thanks to https://github.com/jmmanos/InstagramActivityIndicator/blob/master/InstagramActivityIndicator.swift
